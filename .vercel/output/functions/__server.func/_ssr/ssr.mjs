...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DJnzfCsx.mjs");
...
var manifest = {
	"8e016c7e2f123b990dc2cce000b0a19e46d7ea6019eaa3ecd05246c16f996c47": {
		functionName: "fetchQuotes_createServerFn_handler",
		importer: () => import("./quotes-ChDFJJFC.mjs")
	},
	"e65347b9d06432aece37d17eccee06c36261edb44cdd32291d18262c4530b2fe": {
		functionName: "fetchKlines_createServerFn_handler",
		importer: () => import("./quotes-ChDFJJFC.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BOy5JsEn.mjs").then((n) => n.t),
